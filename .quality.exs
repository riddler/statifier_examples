...
# sets minimum_coverage to 70, not 90, and that is the highest whole number
# this tree actually meets today (70.6%). The reason is that `mix phx.new`
...
# code without moving the floor, so se-rrd's raise covers both; 70 once
# se-06z's host page put the router, the page controller, the icon seam and
# the editor LiveView under test.
#
