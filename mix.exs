defmodule StatifierExamples.MixProject do
  ...
  #
  # The default arm is the Hex release. It was an INTERIM git pin for the
  # length of campaign 021, on the `statifier_blocks` main commit carrying
  # the host marking seam, the drawer host-tab seam and the `invoke_types`
  # assign; 0.9.0 ships all three, so the pin came out (se-p22).
